...
<?php
 ...
 $sql= mysql_query("SELECT visitor_fname,vill_name,circle_name,sch_name,name_of_work,sitedes,stage_name,date_time,longitude,latitude,est_amt,image_photo FROM  `visitor` as v,vp as v1,circle as c,scheme as s,work_master as w,site_type as si,work_stage as ws,work_trans as wt Where v.vp_id = v1.vp_id and c.circle_id = v.circle_id and s.sch_id = v.sch_id and w.work_id = v.work_id and wt.visitor_id = v.visitor_id and si.sitetype_id = v.sitetype_id and ws.stage_id = v.stage_id and v.tal_id=$tal_name") or die(mysql_error());
    ...
    echo "<th width='50px'>"."DateTime"."</th>"; 
	 echo "<th width='50px'>"."Estimated Amount"."</th>";
