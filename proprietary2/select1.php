...
<html>
    <body bgcolor="#FFEBCD">
	  ...
	  <h1 align="center">ZP CIRCLEWISE REPORT</h1>
...
<h3><a href="select8.php">Yearwise Report</a></h3>
            ...
            <table> 
				...
				<tr>
                         <td><h3>Select ZP Circle:</h3></td> <td><select name="circle_name"</td>
 ...
 $sql= mysql_query("SELECT visitor_fname,vill_name,circle_name,sch_name,name_of_work,est_amt,stage_name,date_time,longitude,latitude,image_photo FROM `visitor` as v,vp as v1,circle as c,scheme as s,work_master as w,work_stage as ws,work_trans as wt  Where v.vp_id = v1.vp_id and c.circle_id = v.circle_id and s.sch_id = v.sch_id and w.work_id = v.work_id and ws.stage_id = v.stage_id and wt.visitor_id = v.visitor_id and v.circle_id=$circle_name")or die(mysql_error());
